...
IO.puts("[DAY #{day}.2] Test #{day}.2: #{apply(module, :part2, [File.read!("lib/day#{day}/test") |> String.trim()])}")
IO.puts("[DAY #{day}.2] Real #{day}.2: #{apply(module, :part2, [File.read!("lib/day#{day}/input") |> String.trim()])}")
